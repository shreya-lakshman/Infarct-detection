...
def main():
    ...
    # print(index,max_prob)


    print("PREDICTED OUTPUT:",cat[index])



    # print("REDICTED RESULT:",cat[maxpos])
    ...
    #log.info("This sample is an API example, for any performance measurements please use the dedicated benchmark_ap
